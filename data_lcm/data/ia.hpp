...
#ifndef __data_ia_hpp__
#define __data_ia_hpp__
...
int ia::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int ia::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
const char* ia::getTypeName()
{
    return "ia";
}

int ia::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int ia::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int ia::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t ia::_computeHash(const __lcm_hash_ptr *p)
{
